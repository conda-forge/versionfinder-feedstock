...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/versionfinder-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11780&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/versionfinder-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `versionfinder` can be installed with:

```
conda install versionfinder
```

It is possible to list all of the versions of `versionfinder` available on your platform with:
